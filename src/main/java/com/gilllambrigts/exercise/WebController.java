...
public class WebController {
    ...
    public String fileProcess(@RequestParam(name = "name", defaultValue = "") String fileName) throws IOException {
    ...
    @GetMapping("/api/read")
    public String readAPI(@RequestParam(name = "id", defaultValue = "1") String inputId){
        if (inputId.isEmpty()){
